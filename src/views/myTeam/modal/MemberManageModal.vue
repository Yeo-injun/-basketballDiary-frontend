            ...
            <v-card>
                ...
                <v-tabs-items v-model="tab">
                    <v-tab-item
                        ...
                        :key="title"
                    >
                        <InvitePlayerTab v-if="idx == 0" />
                        <JoinRequestPlayerTab v-if="idx == 1" />
                    </v-tab-item>
                </v-tabs-items>
            </v-card>            
        </div>
...
<script>
import JoinRequestPlayerTab from '@/views/myTeam/modal/JoinRequestPlayerTab.vue';
import InvitePlayerTab from '@/views/myTeam/modal/InvitePlayerTab.vue';

    export default {
        components: {
            InvitePlayerTab,
            JoinRequestPlayerTab,
        },
        data: () => {
            return {
                dialog: false,
