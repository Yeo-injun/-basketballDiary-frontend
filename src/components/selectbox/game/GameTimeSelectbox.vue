<template>
	<v-row>
		<v-col>
			<MinuteSelectbox pLabelName="경기시간-분"
				pUnitType="min"
		...
		<v-col>
			<SecondSelectbox pLabelName="경기시간-초"
				pUnitType="sec" 
...
<script>
	...
	export default {
		...
		data() {
			...
			return {
				minute : validInitVal ? this.pInitVal.substr( 0, 2 ) : '0',
				second : validInitVal ? this.pInitVal.substr( 2, 4 ) : '0',
			};
		},
		methods: {
			selectValue( data ) {
